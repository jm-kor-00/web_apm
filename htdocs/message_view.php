		...
		<section>
			...
			<div id="message_box">
				<h3 class="title">
					...
					if ($mode == "send")
						echo "<span style='font-size:40px;'>송신 쪽지함 > 내용보기</span>";
					else
						echo "<span style='font-size:40px;'>수신 쪽지함 > 내용보기</span>";
					?>
				</h3>
				<ul id="view_content">
					<li>
				...
				<ul class="buttons">
					...
					<li><button
							onclick="location.href='message_delete.php?num=<?= $num ?>&mode=<?= $mode ?>'">삭제</button>
					</li>
				</ul>
			</div> <!-- message_box -->
		</section>
